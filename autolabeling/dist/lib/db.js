...
// --- Like ---
export function upsertLike(rkey, subject, createdAt) {
    db.prepare(`
...
export function deleteLike(rkey) {
    db.prepare('DELETE FROM like WHERE rkey = ?').run(rkey);
}
// --- Post ---
export function upsertPost(rkey, data) {
    db.prepare(`
...
export function deletePost(rkey) {
    db.prepare('DELETE FROM post WHERE rkey = ?').run(rkey);
}
// --- Random ---
export function upsertRandom(rkey, value) {
    db.prepare(`
...
export function deleteRandom(rkey) {
 ...
 */
export function upsertLikeSubject(subjectUri, rkey) {
    db.prepare(`
 ...
 */
export function deleteLikeSubject(subjectUri) {
